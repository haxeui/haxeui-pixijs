...
extern class HaxeUIPixiGraphics extends HaxeUIPixiContainer {
	 ...
	 * @return {Graphics}
	 */
	function clone():HaxeUIPixiGraphics;
	 ...
	 * @return {Graphics}
	 */
	function lineStyle(?lineWidth:Float, ?color:Int, ?alpha:Float):HaxeUIPixiGraphics;
	 ...
	 * @return {Graphics}
	 */
	function moveTo(x:Float, y:Float):HaxeUIPixiGraphics;
	 ...
	 * @return {Graphics}
	 */
	function lineTo(x:Float, y:Float):HaxeUIPixiGraphics;
	 ...
	 * @return {Graphics}
	 */
	function quadraticCurveTo(cpX:Float, cpY:Float, toX:Float, toY:Float):HaxeUIPixiGraphics;
	 ...
	 * @return {Graphics}
	 */
	function bezierCurveTo(cpX:Float, cpY:Float, cpX2:Float, cpY2:Float, toX:Float, toY:Float):HaxeUIPixiGraphics;
	 ...
	 * @return {Graphics}
	 */
	function arcTo(x1:Float, y1:Float, x2:Float, y2:Float, radius:Float):HaxeUIPixiGraphics;
	 ...
	 * @return {Graphics}
	 */
	function arc(cx:Float, cy:Float, radius:Float, startAngle:Float, endAngle:Float, ?anticlockwise:Bool):HaxeUIPixiGraphics;
	 ...
	 * @return {Graphics}
	 */
	function beginFill(?color:Int, ?alpha:Float):HaxeUIPixiGraphics;
	 ...
	 * @return {Graphics}
	 */
	function endFill():HaxeUIPixiGraphics;
	 ...
	 * @return {Graphics}
	 */
	function drawRect(x:Float, y:Float, width:Float, height:Float):HaxeUIPixiGraphics;
 	...
 	*/
	function drawRoundedRect(x:Float, y:Float, width:Float, height:Float, radius:Float):HaxeUIPixiGraphics;
	 ...
	 * @return {Graphics}
	 */
	function drawCircle(x:Float, y:Float, radius:Float):HaxeUIPixiGraphics;
	 ...
	 * @return {Graphics}
	 */
	function drawEllipse(x:Float, y:Float, width:Float, height:Float):HaxeUIPixiGraphics;
	 ...
	 * @return {Graphics}
	 */
	function drawPolygon(path:Array<Float>):HaxeUIPixiGraphics;
	 ...
	 * @return {Graphics}
	 */
	function clear():HaxeUIPixiGraphics;

	/**
	 * Update the bounds of the object
	 *
	 */
	function updateLocalBounds():HaxeUIPixiGraphics;
